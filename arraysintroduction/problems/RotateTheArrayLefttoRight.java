...
public class RotateTheArrayLefttoRight {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter How Many Time Do You Want To Raotate The Array Left to Right : ");
	...
	static void rotateArray(int[] arr, int rotate) {
		...
		reverse(arr, 0, len-1-rotate);
		reverse(arr, (len-1-rotate+1), len - 1);
